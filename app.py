...
PATH ="C:\\Users\\bhavr\\Downloads\\KOA\\minor-proj\\Knee-Ostheoarthritis-Detection-and-Severity-Prediction\\Model Version3.pth"
...
def diagnose_page():
    if request.method == 'POST':
        ...
        # ✅ Dynamic and safe upload path
        upload_folder = os.path.join(app.root_path, 'static', 'uploads')
        os.makedirs(upload_folder, exist_ok=True)  # <-- THIS LINE IS CRITICAL
        ...
        return render_template('diagnosis.html', prediction_text=prediction, image_path=web_path)
...
if __name__ == "__main__":
    app.run(debug=False, port=5001)  # try another port if needed
